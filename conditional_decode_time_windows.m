function std_struct = conditional_decode_time_windows(data1, data2, ind, T, win_len, win_step, ...
                                          n_iter, train_ratio, seed, ...
                                          svm_s, svm_t, svm_c, svm_g)
% Sliding-window SVM decoding on z-power (e.g., cond1 vs. cond2).
%
%
% Inputs:
...
%   n_iter       : iterations per window
%   train_ratio  : per-class train ratio
%   seed         : RNG seed
%   svm_s,svm_t,svm_c,svm_g : LIBSVM params
%
